...
from llm_agent_api.apihelper.settings import (
    CHATS_TXT,
    QDRANT_CHATS,
    EMAILS_TXT,
    QDRANT_EMAILS,
)
from llm_agent_api.apihelper.pipelines import (
    ChatRetrievePipeline,
    EmailRetrievePipeline,
    RetrievalAgent,
)
...
email_retrieve_pipeline = EmailRetrievePipeline(
    EMAILS_TXT, QDRANT_EMAILS, TaskType.EMAIL
)
retrieval_agent = RetrievalAgent(
    chat_retrieve_pipeline.qdrant, email_retrieve_pipeline.qdrant
)
